...
if(JSON.parse(sessionStorage.getItem("lang"))=="ar")
{
   ...
   <div class="container-fluid">
       <a class="navbar-brand" href="./HomeAr.html">
           <img src="./images/main logo.png" alt="" width="40" height="45" class="d-inline-block ms-5 align-text-top">
       </a>
...
{
  cartona=`<nav class="navbar  navbar-expand-lg navbar-light fixed-top pt-3 navbar pb-1 pt-0 navbar-default navbar-static-top custom">
  <div class="container-fluid">
